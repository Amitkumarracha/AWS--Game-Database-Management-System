...
st.markdown(
    ...
    <div style='background-color: #f9f9f9; padding: 20px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);'>
        ...
        <ul style='color: #555;'>
            <li>In a bustling tech hub, four passionate engineers—Bontha Mallikarjun Reddy, Aryan Mallick,Aakash Sharma and Amitkumar Racha—shared a common dream: to revolutionize the way game stores operate.</li>
...
with col4: 
    st.image("images/AMITKUMAR RACHA.jpeg", caption="Amitkumar Racha", width=250)
